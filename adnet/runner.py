...
from adnet import commons
from adnet.boundingbox import BoundingBox, Coordinate
from adnet.configs import ADNetConf
from adnet.networks import ADNetwork
...
class ADNetRunner:
    ...
    def __init__(self):
        ADNetConf.get('./adnet/conf/repo.yaml')
    ...
    def by_dataset(self, vid_path='./adnet/data/freeman1/'):
